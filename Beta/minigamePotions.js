...
PotionsM._registerHooks = function() {
    ...
    if (!Game._potionsGoldenCookieHooked && Game.shimmerTypes && Game.shimmerTypes['golden']) {
        var wrapper = function(me) {
            ...
            var result = wrapper._original.call(this, me);
        ...
        wrapper._original = Game.shimmerTypes['golden'].popFunc;
        Game.shimmerTypes['golden'].popFunc = wrapper;

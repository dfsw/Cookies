    ...
    var CCSEBridge = {
        ...
        protectBeautifyInText: function() {
            if (typeof BeautifyInText === 'function' && !BeautifyInText._CCSEProtected) {
                if (!window._originalBeautifyInText) {
                    window._originalBeautifyInText = BeautifyInText;
                }
                ...
                window.BeautifyInText = function(str, maxLength) {
                    try {
                        ...
                        return window._originalBeautifyInText.call(this, str, maxLength);
                    } catch (e) {
        ...
        protectBeautifyAll: function() {
            if (typeof BeautifyAll === 'function' && !BeautifyAll._CCSEProtected) {
                if (!window._originalBeautifyAll) {
                    window._originalBeautifyAll = BeautifyAll;
                }
                
                window.BeautifyAll = function() {
                    try {
                        return window._originalBeautifyAll.apply(this, arguments);
                    } catch (e) {

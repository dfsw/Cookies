// Test if script is being executed
...
try {
    ...
    console.error('Just Natural Expansion: Error during initialization:', error);
    Game.Popup('Just Natural Expansion: Error during initialization - ' + error.message);
}
